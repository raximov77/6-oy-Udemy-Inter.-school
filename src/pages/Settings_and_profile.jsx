...
function Settings_and_profile() {
    ...
    return (
      ...
      <div className='text-center'>
        ...
        <h3 className='text-[28px] text-[#4F4F4F] font-semibold leading-[34px] mt-[10px]'>No Settings and profile at this time</h3>
      </div>
...
export default Settings_and_profile
